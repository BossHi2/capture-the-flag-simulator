const inputNeurons = ["xPos", "yPos", "SNE", "xDNE","yDNE", "xDNT", "yDNT", "Str", "flag", "xPEF", "yPEF", "xPOF", "yPOF"]//, "SNE", "xDNE","yDNE", "xDNT", "yDNT", "Str", "flag", "xPEF", "yPEF", "xPOF", "yPOF"
...
const redFlagTop = document.getElementById("redFlag").getBoundingClientRect().top
const redFlagBottom = document.getElementById("redFlag").getBoundingClientRect().bottom
const redFlagRight = document.getElementById("redFlag").getBoundingClientRect().right
const blueFlagTop = document.getElementById("blueFlag").getBoundingClientRect().top
const blueFlagBottom = document.getElementById("blueFlag").getBoundingClientRect().bottom
const blueFlagRight = document.getElementById("blueFlag").getBoundingClientRect().right
...
class Player{
    ...
    doAction(){
        ...
        if((this.collidingTickCounter/100) == 3){   //if it has collided for 3 seconds
            this.respawn()
        }
    ...
    findOverlap(){
        ...
        for(var i = 0; i<players.length; i++){
            ...
            if(this.detectOverlap(otherPlayer, currPlayer) && (players[i].isBlue != this.isBlue)){
    ...
    updateHasFlag(){
        if(this.hasFlag == false){
            var enemyFlagId = this.isBlue ? "redFlag" : "blueFlag"
            var playerRect = document.getElementById(this.id).getBoundingClientRect()
            var flagRect = document.getElementById(enemyFlagId).getBoundingClientRect()

            if(this.detectOverlap(playerRect, flagRect)) {
                this.hasFlag = true
                if(this.isBlue)
            ...
            var ownFlagId = this.isBlue ? "blueFlagRadius" : "redFlagRadius"
            var playerRect = document.getElementById(this.id).getBoundingClientRect()
            var flagRect = document.getElementById(ownFlagId).getBoundingClientRect()
    ...
    calculateValue(){
        if(this.name == "xPos"){
            ...
            if(this.player.hasFlag)
                ...
                this.data = 0
        } else if(this.name == "xPEF"){
            if(this.player.isBlue){
                this.data = redFlagRight/width
            } else{
                this.data = blueFlagRight/width
            }
        } else if(this.name == "yPEF"){
            if(this.player.isBlue){
                this.data = redFlagBottom/height
            } else{
                this.data = blueFlagBottom/height
            }
        } else if(this.name == "xPOF"){
            if(this.player.isBlue){
                this.data = blueFlagRight/width
            } else{
                this.data = redFlagRight/width
            }
        } else if(this.name == "yPOF"){
            if(this.player.isBlue){
                this.data = blueFlagBottom/height
            } else{
                this.data = redFlagBottom/height
